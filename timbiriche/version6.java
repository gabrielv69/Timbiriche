    ...
    public int ingreso(List<Nodotimb> hijosar) {
        ...
        try {
            ...
            if (a > hijosar.size()) {
                ...
                System.out.println("Solo entre 1 y " + hijosar.size());
                ingreso(hijosar);
            }
...
boolean repe=false;
boolean repetuche=false;
boolean finalsi=false;

        while (finalsi==false) {            
            
        
        Object [] player1 = playerone(raiz);
        Nodotimb siguiente = (Nodotimb) player1 [0];
        repe = (boolean) player1 [1]; 
        
        while (repe==true) {
            armarniveles(siguiente);
            player1 =playerone(siguiente);
            siguiente = (Nodotimb) player1 [0];
            repe = (boolean) player1 [1]; 
            boolean r =fin(siguiente);
            if (r==true){
                repe=false;
                finalsi=true;
        ...
        if (h==false) {     
            armarniveles(siguiente);
            Object [] player2 = playertwo (siguiente);
            Nodotimb next= (Nodotimb) player2[0];
            repetuche = (boolean) player2 [1];
            
        while (repetuche==true){
            armarniveles(next);
            player2 = playertwo(next);
            next = (Nodotimb) player2[0];
            repetuche = (boolean) player2[1];
            boolean m = fin(next);
            if (m==true){
                repetuche=false;
    ...
    public Object [] playerone(Nodotimb raiz){
        String jugadora;
        boolean repe;
    ...
    public Object [] playertwo(Nodotimb siguiente){
        String jugadorb;
        
        System.out.println("\033[35mSegundo Jugador");
        jugadorb="J2";
        Nodotimb next = usuario(siguiente);
        Object []otra=encierro(jugadorb, next);
