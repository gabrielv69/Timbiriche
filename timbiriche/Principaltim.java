...
public class Principaltim {
    ...
    public List<Object[][]> buscarhijos(Object[][] estadoinicial) {
        ...
        hijosencontrados = hijosposibles(matrizvacia);
    ...
    public boolean compararfinal(List<Object[][]> mat) {
        ...
        for (int i = 0; i < mat.size(); i++) {
            ...
            if (comparador == true) {
                System.out.println("final=" + comparador);
            }
        }
        return comparador;
    }
...
//        boolean nivel = compararfinal(estados);
        if (finalsito == false) {
